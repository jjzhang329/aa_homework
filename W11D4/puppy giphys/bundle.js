...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dispatch) {
    console.log(_util_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchSearchGiphys"](searchTerm));
...
var GiphysIndexItem = function GiphysIndexItem(giphy) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchSearchGiphys: function fetchSearchGiphys(searchTerm) {
      dispatch(Object(_actions_giphy_actions__WEBPACK_IMPORTED_MODULE_2__["fetchSearchGiphys"])(searchTerm));
    }
  };
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.store = store;
  var root = document.getElementById('root'); // window.fetchSearchGiphys = fetchSearchGiphys
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=87Yxok6N9aU2CplNPTD0wwK3orOIQVDu&limit=2")
  });
};
